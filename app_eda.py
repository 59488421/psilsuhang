...
class PopulationEDA:
    def __init__(self):
        ...
        with tabs[2]:
            ...
            st.markdown(
                """
                해설: 상위권에 있는 지역들은 최근 5년간 인구 유입이 많았거나, 지속적인 개발이 이루어졌을 가능성이 큽니다.
                반면, 하위권 지역은 고령화가 진행 중이거나 인구가 꾸준히 빠져나갔을 수 있습니다.
                단순한 인구 변화량뿐만 아니라 변화율(%)까지 함께 보면, 각 지역의 성장 혹은 감소 추세를 더 정확하게 파악할 수 있습니다.
                """
            )
